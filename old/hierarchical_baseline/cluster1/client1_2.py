...
class CifarClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        model.fit(train_images, train_labels, epochs=1, batch_size=32, steps_per_epoch=100)
...
# Start Flower client
fl.client.start_numpy_client(server_address="127.0.0.1:5001", client=CifarClient())